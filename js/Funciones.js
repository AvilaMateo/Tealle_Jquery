...
function comprobar() {
 ...
 function color(){
    ...
    var cont =0;
    if($("input[name='rst']").is(':checked')){
         rest = $("input[name='rst']:checked").val();
            if(rest == respuestasCorrectas[0]){
    ...
    if($("input[name='rst1']").is(':checked')){
         rest = $("input[name='rst1']:checked").val();
            if(rest == respuestasCorrectas[1]){
    ...
    if($("input[name='rst2']").is(':checked')){
         rest = $("input[name='rst2']:checked").val();
            if(rest == respuestasCorrectas[2]){
               $("#item2").css({ "background": "green" }); 
        }else{
    ...
    if($("input[name='rst3']").is(':checked')){
         rest = $("input[name='rst3']:checked").val();
            if(rest == respuestasCorrectas[3]){
    ...
    if($("input[name='rst4']").is(':checked')){
         rest = $("input[name='rst4']:checked").val();
            if(rest == respuestasCorrectas[4]){
    ...
    if($("input[name='rst5']").is(':checked')){
         rest = $("input[name='rst5']:checked").val();
            if(rest == respuestasCorrectas[5]){
               $("#item5").css({ "background": "green" }); 
        }else{
            $("#item5").css({ "background": "red" }); 
        }
        cont += 1;
    }
    
    if($("input[name='rst6']").is(':checked')){
         rest = $("input[name='rst6']:checked").val();
            if(rest == respuestasCorrectas[6]){
               $("#item6").css({ "background": "green" }); 
        }else{
            $("#item6").css({ "background": "red" }); 
        }
        cont += 1;
    }
    
    if($("input[name='rst7']").is(':checked')){
         rest = $("input[name='rst7']:checked").val();
            if(rest == respuestasCorrectas[7]){
               $("#item7").css({ "background": "green" }); 
        }else{
            $("#item7").css({ "background": "red" }); 
        }
        cont += 1;
    }
    
    if($("input[name='rst8']").is(':checked')){
         rest = $("input[name='rst8']:checked").val();
            if(rest == respuestasCorrectas[8]){
               $("#item8").css({ "background": "green" }); 
        }else{
            $("#item8").css({ "background": "red" }); 
        }
        cont += 1;
    }
